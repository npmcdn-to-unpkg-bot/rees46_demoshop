class ProductsController < ApplicationController
  ...
  def product_params
    params.require(:product).permit(:title, :image, :description, :price, :brand, :category_id, :industry, :gender, :size, :hypoallergenic, :periodic, :child_sizes, russian_sizes: [], euro_sizes: [], british_sizes: [], american_sizes: [], asian_sizes: [], part_types: [], skin_types: [], conditions: [], ages: [], volumes_attributes: [:product_id, :value, :value_price, :_destroy])
  end
end
