...
ActiveRecord::Schema.define(version: 20_160_411_131_438) do
  ...
  add_index 'redactor_assets', %w(assetable_type assetable_id), name: 'idx_redactor_assetable', using: :btree
  add_index 'redactor_assets', %w(assetable_type type assetable_id), name: 'idx_redactor_assetable_type', using: :btree
  ...
  add_index 'volumes', ['product_id'], name: 'index_volumes_on_product_id', using: :btree
